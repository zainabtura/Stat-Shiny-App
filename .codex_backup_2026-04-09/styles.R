...
:root {
  ...
  --warning: #f59e0b;
  --danger: #ef4444;
  --sidebar: linear-gradient(180deg, #f8f9ff 0%, #f0f1ff 100%);
}
...
.home-hero-panel {
  ...
  background:
    ...
    radial-gradient(circle at 100% 100%, rgba(168, 85, 247, 0.10), transparent 30%),
    linear-gradient(135deg, rgba(245, 244, 255, 0.98) 0%, rgba(255, 255, 255, 0.98) 42%, rgba(245, 243, 255, 0.98) 100%);
...
.home-hero-button-primary.btn {
  background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%);
  color: #ffffff;
}

.home-hero-button-primary.btn:hover {
  background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%);
  color: #ffffff;
}

.home-hero-button-secondary.btn {
  background: rgba(255, 255, 255, 0.92);
  color: var(--brand-dark);
  border-color: rgba(99, 102, 241, 0.12);
}

.home-hero-button-secondary.btn:hover {
  background: #ffffff;
  color: var(--brand-dark);
}
...
.home-study-card:nth-child(2) {
  background: #eef2ff;
  border-top-color: rgba(99, 102, 241, 0.38);
}

.home-study-card:nth-child(3) {
  background: #f5f3ff;
  border-top-color: rgba(168, 85, 247, 0.35);
}

.home-study-card:nth-child(4) {
  background: #fdf2f8;
  border-top-color: rgba(236, 72, 153, 0.32);
}

.home-study-card:nth-child(1) {
  background: #eef2ff;
  border-top-color: rgba(99, 102, 241, 0.38);
}

.home-study-card:hover {
...
.home-study-icon {
  ...
  height: 52px;
  border-radius: 18px;
  background: linear-gradient(180deg, rgba(99, 102, 241, 0.16) 0%, rgba(99, 102, 241, 0.08) 100%);
  color: var(--brand);
  font-size: 22px;
}
...
.upload-page-label {
  ...
  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.7), 0 16px 30px rgba(99, 102, 241, 0.10);
}

.upload-page-label:hover {
  transform: translateY(-2px);
  border-color: rgba(99, 102, 241, 0.65);
  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.82), 0 22px 38px rgba(99, 102, 241, 0.14);
}
...
.upload-empty-state {
  background:
    ...
    linear-gradient(180deg, rgba(255, 255, 255, 0.97) 0%, rgba(245, 243, 255, 0.95) 100%);
  border: 1px solid rgba(99, 102, 241, 0.12);
}
...
.upload-results-card {
  background:
    ...
    linear-gradient(180deg, rgba(255, 255, 255, 0.97) 0%, rgba(245, 243, 255, 0.96) 100%);
  padding: 26px;
}
...
.upload-stat-card {
  ...
  border-radius: 18px;
  border: 1px solid rgba(99, 102, 241, 0.10);
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.96) 0%, rgba(245, 243, 255, 0.96) 100%);
  box-shadow: 0 10px 24px rgba(19, 42, 35, 0.05);
  overflow: hidden;
}
...
.app-shell.sidebar-collapsed .nav-button.btn.is-active {
  background: linear-gradient(135deg, rgba(99, 102, 241, 0.24) 0%, rgba(168, 85, 247, 0.24) 100%);
  box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.08), 0 12px 22px rgba(79, 70, 229, 0.18);
}
